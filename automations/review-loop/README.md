...
that lane's canonical worktree path. This is strictly an operator-facing
association: the persisted TARS lane record remains the source of truth for
session roles and workflow state.
